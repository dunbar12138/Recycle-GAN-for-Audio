...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--display_id', type=int, default=1, help='window id of the web2 display')
        self.parser.add_argument('--display_port', type=int, default=8097, help='visdom port of the web2 display')
